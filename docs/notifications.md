...
У swaync пока отдельная фиксированная палитра: чёрный полупрозрачный фон
`rgba(0, 0, 0, 0.95)`, радиус 20 px, Cantarell 13/600 и розовые акценты. Выбор
акцента в Waybar её не меняет.
