...
Направление `Alt+колесо` соответствует горизонтальной ленте: колесо
вверх/вперёд передаёт `step = 1` и идёт на следующий стол справа;
вниз/назад передаёт `step = -1` и идёт на предыдущий слева.
